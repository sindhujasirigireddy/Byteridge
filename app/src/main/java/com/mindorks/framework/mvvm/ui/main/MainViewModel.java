...
public class MainViewModel extends BaseViewModel<MainNavigator> {
    ...
    private final ObservableField<HashMap<Integer, Boolean>> attemptedTestResults = new ObservableField<>();
    ...
    public MainViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
        ...
        attemptedTestResults.set(new HashMap<>());
    ...
    public ObservableField<HashMap<Integer, Boolean>> getAttemptedTestResults() {
        return attemptedTestResults;
    }

    public void resetAttemptedQuestionCount() {
        attemptedTestResults.set(new HashMap<>());
    }
}
